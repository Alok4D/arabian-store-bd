...
export function LiveChatWidget() {
  ...
  return (
    ...
    >
      ...
      >
        <a href="tel:01817113624" className="w-[50px] h-[50px] rounded-full bg-[#00d366] flex items-center justify-center text-white shadow-md hover:scale-110 transition-transform">
          <Phone fill="currentColor" size={24} />
        </a>
        
        <a href="https://www.facebook.com/ArabianStorebd" target="_blank" rel="noopener noreferrer" className="w-[50px] h-[50px] rounded-full bg-[#0084ff] flex items-center justify-center text-white shadow-md hover:scale-110 transition-transform">
        ...
        <a href="https://wa.me/8801817113624" target="_blank" rel="noopener noreferrer" className="w-[50px] h-[50px] rounded-full bg-[#25d366] flex items-center justify-center text-white shadow-md hover:scale-110 transition-transform">
